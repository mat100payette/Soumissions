...
namespace SilverlightCustomControls
{
    ...
    {       
        ...
        public static void SetMultiBinding(DependencyObject target, DependencyProperty dp, MultiBinding multiBinding)
        {
            Binding binding = multiBinding.ApplyToTarget(target);
